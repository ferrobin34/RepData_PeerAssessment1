...
The mean is **`r steps_mean`** and the median is **`r steps_median`** for the total number of steps taken per day.
...
The 5-minute interval with the maximun average steps is the interval **`r maximun_interval`** with **`r maximun_steps`** average steps.
...
```
There are **`r number_na`** of NA's in the data.
...
The new steps mean and median are **`r new_steps_mean`** 
and **`r new_steps_median`** respectively.
...
|DATA       |Mean              |Median              |
|---------|:----------------:|-------------------:|
|new data | `r steps_mean`   |`r steps_median`    |
|old data |`r new_steps_mean`|`r new_steps_median`|
